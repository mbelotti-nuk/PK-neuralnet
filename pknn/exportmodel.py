...
To use export module, a '.yaml' file has to be used as the one present in /examples/export_to_NACARTE_example/config.yaml.
To run the command: 
``$ exportpknn --config [path_to_config_file]`` """
...
import pickle
from pknn.net.datamanager import  scaler_to_txt
